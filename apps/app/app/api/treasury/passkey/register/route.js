...
export async function POST(request) {
  try {
    ...
    if (pending.actorUserId && pending.actorUserId !== actor.userId) {
      return NextResponse.json({ error: 'challenge_forbidden', message: 'Passkey challenge belongs to a different operator.' }, { status: 403 })
    }
